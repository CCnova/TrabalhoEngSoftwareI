...
public class BaseDeDados {
	...
	public void carregarDadosIniciais() {
		...
		livros.add(new Livro(300, "Refactoring: Improving the Design of Existing Code", "Addison-Wesley Professional",
				Arrays.asList("Martin Fowler"), "1ª", 1999));
		livros.add(new Livro(301, "Software Metrics: A Rigorous and Practical Approach", "CRC Press",
